<script>
    ...
    var questionsArray = [
        "How many evil exs did Scott Pilgram have to defeat?",
        "Who was the final evil ex Scott Pilgram had to defeat?"
    ];
    var answersArray = [
        ["Four", "Seven", "Twenty-Three", "Fifteen"],
        ["Gideon Gordon Graves", "Roxan 'Roxie' Riches", "Todd Ingram", "Matthew Patel"]
    ];
    var correctArray = [
        "B. Seven",
        "A. Gideon Gordon Graves"
    ];
    var correctNum = 0;
    var incorrectNum = 0;
    var notAnsweredNum = 0;
